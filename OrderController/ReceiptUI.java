...
public class ReceiptUI extends JFrame implements ActionListener {
    ...
    public ReceiptUI(Receipt servedOrder) {
    ...
    public void createFile() {
        ...
        try {
            ...
            myWriter.write(
                    o.toString() + "@" + served.getTotal() + "@" + served.getPayment() + "@" + served.getChange());
